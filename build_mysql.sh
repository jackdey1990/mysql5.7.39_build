...
#
# Instructions:
# Execute build script: bash script.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="mysql-server"
PACKAGE_VERSION="5.7.39"
SOURCE_ROOT="$(pwd)"
...
function printHelp() {
    echo
    echo "Usage: "
    echo "bash build_mysql.sh  [-d debug] [-y install-without-confirmation] [-t install-with-tests] "
    echo
}
